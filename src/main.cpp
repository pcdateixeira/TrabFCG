...
int main(int argc, char* argv[])
{
    ...
    // Criamos uma janela do sistema operacional, com 800 colunas e 600 linhas de pixels
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 228509 - Pedro Caetano de Abreu Teixeira", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
